...
additionalCovBMI1 = 0.005 #effect of covariate on the early endpoint
additionalCovBMI2 = 0.005 #effect of covariate on the final endpoint
...
settings['Ext4',]=  c(1239, n0, baselineBMI_ext, eff10 - 0.5*0.0015 , eff20 - 0.5*0.003, 0, 0) # approx 0.5 St.Error away
settings['Ext5',]=  c(1240, n0, baselineBMI_ext, eff10 - 3*0.0015 , eff20 - 3*0.003, 0, 0)  # approx 3 St.Error away
#settings['Ext4',]=  c(1239, n0, baselineBMI_ext, eff10 - 0.025/16 , eff20 -  0.025/16, 0, 0) # unit information SD: approx 0.025
#settings['Ext5',]=  c(1240, n0, baselineBMI_ext, eff10 -  0.025/2 , eff20 -  0.025/2, 0, 0)  
...
save(Sim,file='~/Documents/NISSWorkingGroup/TrialData.RData')
